"""
URL configuration for sport_tracker project.
...
urlpatterns = [
    ...
    path('inventory/new', new_inventory, name='inventory/new'),
    path('inventory/delete', delete_inventory, name='inventory/delete'),
    ...
    path('add_inventory/<int:inventory_id>/', add_inventory, name='add_inventory'),
    path('secure_inventory/', secure_inventory, name='secure_inventory'),
    path('user_detail/<int:user_id>/', user_detail, name='user_detail'),
    path('issue_inventory/<int:user_id>/<int:inventory_id>/<str:item_name>/', issue_inventory, name='issue_inventory'),
